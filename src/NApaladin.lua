function getNA2Actions(no)
  ...
  elseif(no == 0)then
    return {'20271'};
  elseif(no == 1)then
    return {'633','642','184662','19750','205191','853','205273','31884','20271','85256','224668','184575','35395','53385'};
  elseif(no == 2)then
    ...
    if(W_TargetCanAttack()) then  --攻击施法
      ...
      elseif(NA_ProfileNo == 1)then --惩戒骑
        ...
        if(not NA_IsAOE and (false
					...
					or NA_Fire(NA_checkHP(0), '184662', NA_Player) --复仇之盾
					or NA_Fire(NA_checkHP(0), '19750', NA_Player) --圣光闪现
					or NA_Fire(NA_IsSolo and NA_checkHP(2), '205191', NA_Nil) --以眼还眼
					or NA_Fire(NA_IsSolo, '853', NA_Target) --制裁之锤
					or NA_Fire(true, '205273', NA_Nil) --灰烬觉醒
